...
public class RecognizerTask implements Runnable {
	...
	public RecognizerTask() {
		File f = new File("/sdcard/Recallin/edu.cmu.pocketsphinx/");
		if(!f.exists()) {
			f.mkdirs();
		}
		
		pocketsphinx
				.setLogfile("/sdcard/Recallin/edu.cmu.pocketsphinx/pocketsphinx.log");
		Config c = new Config();
		/*
		 ...
		 */
		c.setString("-hmm",
				"/sdcard/Recallin/edu.cmu.pocketsphinx/hmm/en_US/hub4wsj_sc_8k");
		c.setString("-dict",
				"/sdcard/Recallin/edu.cmu.pocketsphinx/lm/en_US/hub4.5000.dic");
		c.setString("-lm",
				"/sdcard/Recallin/edu.cmu.pocketsphinx/lm/en_US/hub4.5000.DMP");
		/*
		 * c.setString("-hmm",
		 ...
		 * );
		 */
		c.setString("-rawlogdir", "/sdcard/Recallin/edu.cmu.pocketsphinx");
